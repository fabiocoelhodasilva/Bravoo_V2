...
const PAISES_MAP: PaisItem[] = [
  ...
  { en: "Spain", pt: "Espanha" },
  { en: "France", pt: "França" },
  { en: "England", pt: "Inglaterra", aliases: ["United Kingdom", "UK"] },
  { en: "Italy", pt: "Itália" },
  { en: "Portugal", pt: "Portugal" },
];

const PONTUACAO_INICIAL = 6;

const ATIVIDADE_ID = "55555555-5555-5555-5555-555555555001";
const MATERIA_ID = "d366c6de-2345-4bb2-ac1f-a88747a2248d";
const ASSUNTO_ID = "cb092890-2955-4eab-a84f-8f6548cb4eb6";
const DETALHE_ID = "55555555-5555-5555-5555-555555555002";

export default function EuropaOcidentalPaisesPage() {
