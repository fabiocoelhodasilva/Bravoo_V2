...
export default function GeografiaMenu() {
  ...
  useEffect(() => {
    ...
    async function carregarJoiasGeografia() {
      try {
        const {
          data: { user },
          error,
        ...
        console.error("Erro ao carregar joias da semana de Geografia:", error);
