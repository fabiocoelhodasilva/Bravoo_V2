...
/**
 * BUSCAR SALDO DE ITENS DO JARDIM HOJE
 */
...
/**
 * SINCRONIZAR CRÉDITOS DO JARDIM PELOS MINUTOS DO DIA
 */
...
export async function registrarMomentoOracao(minutos: number) {
  ...
  try {
    const sessao = await salvarSessaoAtividade({
      atividade_id: ATIVIDADE_ORACAO_ID,
      materia_id: MATERIA_ESPIRITUAL_ID,
...
/**
 * REGISTRAR USO DE 1 CRÉDITO AO PLANTAR ITEM
 */
