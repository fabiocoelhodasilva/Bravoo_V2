...
const outputPath = path.join(__dirname, "../public/dados/europa-ocidental-simplified.geojson");
...
try {
  ...
  console.log(
    "🔎 Nomes parecidos encontrados no arquivo original:",
    allNames.filter((name) =>
      /king|brit|eng|scot|wales/i.test(name)
    )
  );
} catch (error) {
